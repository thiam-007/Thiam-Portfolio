                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {currentItems.map((project) => (
                            <Link
                                ...
                                className="group bg-[var(--secondary)] rounded-lg overflow-hidden shadow-lg project-card transition-all duration-300 border border-transparent hover:border-[var(--accent)] hover:border-opacity-40 hover:-translate-y-2 block"
                            >
