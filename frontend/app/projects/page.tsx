                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {currentItems.map((project) => (
                            <Link
                                ...
                                className="bg-[var(--secondary)] rounded-lg overflow-hidden shadow-lg project-card transition-all duration-300 block border border-transparent hover:border-[var(--accent)] hover:border-opacity-30"
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <span className="text-[var(--accent)] flex items-center font-medium">
