            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 pt-10 pb-16">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: 'var(--blog-text)' }}>
                            Articles &amp;{' '}
                            <span style={{ color: 'var(--blog-accent)' }}>Réflexions</span>
                        </h1>
                        <p className="text-base max-w-xl mx-auto" style={{ color: 'var(--blog-muted)' }}>
                            Développement, stratégie produit et gestion de projets tech — du terrain à la pratique.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-14">
                        ...
                        >
                            ...
                            >
                                <svg width="220" height="160" viewBox="0 0 220 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="2" y="34" width="44" height="124" fill="#0a1120"/>
                            ...
                            <h3 className="text-sm font-bold mb-1" style={{ color: 'var(--blog-text)' }}>Développement Web</h3>
                            <p className="text-xs leading-relaxed" style={{ color: 'var(--blog-muted)' }}>React, Next.js, Node.js — architectures modernes et bonnes pratiques.</p>
                        </motion.div>
                        ...
                        >
                            ...
                            <h3 className="text-sm font-bold mb-1" style={{ color: 'var(--blog-text)' }}>Gestion de Projet</h3>
                            <p className="text-xs leading-relaxed" style={{ color: 'var(--blog-muted)' }}>Agile, Scrum, PMP — piloter des équipes et livrer de la valeur.</p>
                        </motion.div>
                        ...
                        >
                            ...
                            >
                                <svg width="220" height="160" viewBox="0 0 220 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <circle cx="182" cy="108" r="22" fill="none" stroke="#6366F1" strokeWidth="10" strokeDasharray="55 83" strokeDashoffset="22" strokeLinecap="round"/>
                                    <circle cx="182" cy="108" r="22" fill="none" stroke="#38BDF8" strokeWidth="10" strokeDasharray="28 110" strokeDashoffset="-33" strokeLinecap="round" opacity="0.7"/>
                            ...
                            <h3 className="text-sm font-bold mb-1" style={{ color: 'var(--blog-text)' }}>Stratégie & Data</h3>
                            <p className="text-xs leading-relaxed" style={{ color: 'var(--blog-muted)' }}>Power BI, analyse stratégique — transformer les données en décisions.</p>
                        </motion.div>
                    ...
                    {blogs && (
                        <motion.div
                            className="flex flex-wrap justify-center gap-6 mb-7"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            {[
                                ...
                                <div key={stat.label} className="flex items-center gap-2">
                                    ...
                                    <span className="font-bold text-sm" style={{ color: 'var(--blog-text)' }}>{stat.value}</span>
                                    <span className="text-xs" style={{ color: 'var(--blog-muted)' }}>{stat.label}</span>
                                </div>
                            ))}
                        </motion.div>
                    )}
                    ...
                    >
                        <a href={linkedin} target="_blank" rel="noopener noreferrer"
                            ...
                            style={{ backgroundColor: 'rgba(99,102,241,0.1)', color: 'var(--blog-accent)', border: '1px solid rgba(99,102,241,0.25)' }}>
                            <i className="fab fa-linkedin-in" /> LinkedIn
                        </a>
                        <a href={github} target="_blank" rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium"
                            style={{ backgroundColor: 'var(--blog-surface)', color: 'var(--blog-muted)', border: '1px solid var(--blog-border)' }}>
